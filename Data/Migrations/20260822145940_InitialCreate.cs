        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Hospital = table.Column<string>(type: "TEXT", maxLength: 150, nullable: false),
                    District = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BloodRequests_AspNetUsers_CoordinatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitsGiven = table.Column<int>(type: "INTEGER", nullable: false),
                    ConfirmedByCoordinator = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DonationRecords", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DonationRecords_BloodRequests_RequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BloodRequests_CoordinatorId",
                table: "BloodRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DonationRecords_RequestId",
                table: "DonationRecords",
                column: "RequestId");
